structure KeisankiLexer  = struct
...
let
fun yyAction0 (strm, lastMatch : yymatch) = (yystrm := strm;  T.LET)
fun yyAction1 (strm, lastMatch : yymatch) = (yystrm := strm;  T.IN)
...
fun yyAction8 (strm, lastMatch : yymatch) = (yystrm := strm;  T.LPAREN)
fun yyAction9 (strm, lastMatch : yymatch) = (yystrm := strm;  T.RPAREN)
        ...
        | SOME(inp, strm') =>
            if inp = 0wx5B
              ...
              then if inp = 0wx3A
                  ...
                  then if inp <= 0wx2F
                      then yyAction2(strm, yyNO_MATCH)
                      else yyQ13(strm', yyMATCH(strm, yyAction2, yyNO_MATCH))
                else if inp <= 0wx40
                  then yyAction2(strm, yyNO_MATCH)
                  else yyQ13(strm', yyMATCH(strm, yyAction2, yyNO_MATCH))
            else if inp = 0wx74
